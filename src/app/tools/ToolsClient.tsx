          ...
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed font-normal font-manrope">
              <HeroWords delay={heroEnd(2)}>
                Advanced reconnaissance and asset monitoring tools used by our
                own red teams. Now available for your security operations.
              </HeroWords>
            </p>
          </div>
        </div>
            ...
            {tools.map((tool, idx) => (
              ...
              >
                <div className="flex justify-between items-start mb-8 md:mb-12">
                  <tool.icon
                    className="w-6 h-6 md:w-8 md:h-8 text-foreground/80 group-hover:text-foreground transition-colors"
                    strokeWidth={1.5}
                  />
