                            ...
                            <form onSubmit={handleSubmit} className="relative z-10 space-y-8">
                                <div className="space-y-6">
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                             <label htmlFor="name" className="text-sm font-bold text-foreground/80 mb-2 ml-1 block">Full Name</label>
                                            <input
                                                name="name"
                                                id="name"
                                                type="text"
                                    ...
                                    <div className="space-y-2">
                                         <label htmlFor="subject" className="text-sm font-bold text-foreground/80 mb-2 ml-1 block">Inquiry Type</label>
                                        <Select value={subject} onValueChange={setSubject} required>
                                             ...
                                             <SelectContent className="bg-card border-border rounded-xl shadow-lg">
                                                ...
                                                <SelectItem value="Sales Inquiry" className="text-foreground focus:bg-muted cursor-pointer">Sales Inquiry</SelectItem>
                                                <SelectItem value="Seminar Booking" className="text-foreground focus:bg-muted cursor-pointer">Seminar Booking</SelectItem>
                                                <SelectItem value="Technical Support" className="text-foreground focus:bg-muted cursor-pointer">Technical Support</SelectItem>
                                                <SelectItem value="Partnership" className="text-foreground focus:bg-muted cursor-pointer">Partnership</SelectItem>
                                                <SelectItem value="Media / Press" className="text-foreground focus:bg-muted cursor-pointer">Media / Press</SelectItem>
                                                <SelectItem value="Schedule a Call" className="text-foreground focus:bg-muted cursor-pointer">Schedule a Call</SelectItem>
                                    ...
                                    <div className="space-y-2">
                                         <label className="text-sm font-bold text-foreground/80 mb-2 ml-1 block">Preferred Date & Time (Optional)</label>
                                        <DateTimePicker
                                            name="preferred-date"
                                        ...
                                        />
                                         <p className="text-xs text-muted-foreground ml-1">Select if you&apos;d like to schedule a call with our team</p>
                                    </div>

                                    <div className="space-y-2">
                                         <label htmlFor="message" className="text-sm font-bold text-foreground/80 mb-2 ml-1 block">Message</label>
                                        <textarea
                                            name="message"
                                            id="message"
                                            rows={4}
                                ...
                                <button
                                    ...
                                    disabled={isSubmitting}
                                     className="w-full h-14 bg-foreground text-background hover:bg-foreground/90 active:scale-[0.98] rounded-xl font-bold text-sm transition-all duration-300 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {isSubmitting ? (
                                        <>
