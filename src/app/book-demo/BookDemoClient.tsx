...
function BookDemoContent() {
  ...
  const getGoogleCalendarUrl = () => {
    ...
    const end = new Date(preferredDate.getTime() + 60 * 60 * 1000)
      .toISOString()
      .replace(/-|:|\.\d\d\d/g, ""); // 1 hour duration
          ...
          <div>
            ...
            <p className="text-xl text-muted-foreground font-manrope font-normal leading-relaxed">
              <HeroWords delay={heroEnd(4)}>
                Get a personalized walkthrough of how we can help secure your
                applications, cloud infrastructure, or AI systems.
              </HeroWords>
            </p>
          </div>
            ...
            <div className="relative z-10">
              <div className="mb-10">
                ...
                <p className="text-muted-foreground text-sm font-medium">
                  Experience the power of ZecurX tailored for your team.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {service && (
                  <div className="p-4 bg-muted border border-border rounded-xl">
                    <p className="text-xs font-bold uppercase tracking-widest text-muted-foreground">
                      Service Interest:{" "}
                      <span className="text-foreground ml-2">{service}</span>
                    </p>
                  </div>
                )}
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground ml-1">
                    Optional - our team will coordinate with you
                  </p>
                </div>
