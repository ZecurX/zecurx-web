...
export default async function AdminLayout({ children }: { children: ReactNode }) {
    ...
    const navItems = [
        ...
        },
        {
            ...
            children: [
                {
                    href: "/zx-ctrl-6fdbff/referral-codes",
                    label: "Referral Codes",
                    icon: "Ticket",
                    visible: true
                },
                {
                    href: "/zx-ctrl-6fdbff/partner-referrals",
