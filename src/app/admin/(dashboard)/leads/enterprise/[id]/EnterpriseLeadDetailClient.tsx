...
export default function EnterpriseLeadDetailClient({ leadId }: EnterpriseLeadDetailClientProps) {
    ...
    useEffect(() => {
        const fetchLead = async () => {
            try {
                ...
                router.push('/admin/leads/enterprise');
            } finally {
                setIsLoading(false);
            }
        };
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            if (response.ok) router.push('/admin/leads/enterprise');
        } catch (error) {
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-4">
                    <Link href="/admin/leads/enterprise" className="p-2 rounded-lg hover:bg-white/[0.04] text-muted-foreground hover:text-foreground mt-1">
