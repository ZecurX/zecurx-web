                                ...
                                {isLoading ? (
                                    ...
                                    leads.map((lead) => (
                                        <tr key={lead.id} className="hover:bg-white/[0.02] transition-colors">
                                            ...
                                            <td className="px-5 py-4">
                                                <div className="flex items-center gap-2">
                                                    <Link href={`/admin/leads/enterprise/${lead.id}`} className="p-2 rounded-lg hover:bg-white/[0.04] text-muted-foreground hover:text-foreground">
                    ...
                    leads.map((lead) => (
                        <article key={lead.id} className={cn(cardClass, "!p-4 space-y-3")}>
                            <div className="flex items-start justify-between gap-3">
                                ...
                                <Link href={`/admin/leads/enterprise/${lead.id}`} className="p-2 rounded-lg bg-white/[0.03] border border-white/[0.06]">
                                    <Eye className="w-4 h-4" />
                                </Link>
                            </div>
