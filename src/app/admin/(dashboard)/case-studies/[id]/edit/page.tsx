...
import { UpdateCaseStudyRequest, CaseStudyStatus, CaseStudy } from '@/types/auth';
...
export default function EditCaseStudyPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handlePdfUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      const url = await uploadFileToS3(file, 'case-studies');
      setPdfUrl(url);
    } catch (err: unknown) {
  ...
  const handleSubmit = async (newStatus: CaseStudyStatus) => {
    if (!title.trim()) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold font-manrope text-foreground">Edit Case Study</h1>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-card/40 border border-border/50 rounded-2xl p-6 space-y-4 backdrop-blur-sm">
              ...
              <textarea
                ...
                rows={6}
                placeholder="Write a compelling summary of the case study..."
