...
export default function NewCaseStudyPage() {
  ...
  const handleSubmit = async (status: CaseStudyStatus) => {
    if (!title.trim()) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold font-manrope text-foreground">New Case Study</h1>
                <p className="text-xs text-muted-foreground mt-0.5">Upload a customer case study or success story</p>
              </div>
            </div>
