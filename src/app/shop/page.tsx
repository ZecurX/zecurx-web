            ...
            <div className="max-w-4xl flex flex-col items-center text-center">
              ...
              <p className="text-xl text-muted-foreground font-light max-w-2xl mb-10 leading-relaxed font-manrope">
                <HeroWords delay={heroEnd(5)}>
                  Equip yourself with industry-standard tools for penetration
                  testing, RFID analysis, and network auditing.
                </HeroWords>
              </p>
            </div>
          </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-20">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div
                    key={i}
                    className="bg-muted/20 rounded-3xl h-[400px] animate-pulse border border-border/20"
                  />
                ))}
              </div>
            </div>
        ...
        <section className="py-24 border-t border-border/40 bg-muted/10">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-4 font-manrope">
                Why Choose ZecurX?
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-8 rounded-3xl bg-card border border-border/50 hover:border-border transition-colors group md:col-span-2 relative overflow-hidden shadow-sm">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-8 h-full">
                  <div className="flex-1">
                    ...
                    <a
                      href="/academy"
                      className="inline-flex items-center text-sm font-bold text-foreground border-b border-primary pb-0.5 hover:text-primary transition-colors"
                    >
              ...
              <div className="md:col-span-2 p-8 rounded-3xl bg-foreground text-background transition-colors group relative overflow-hidden flex items-center shadow-lg">
                ...
                <div className="relative z-10 w-full flex justify-between items-center">
                  ...
                  <a
                    href="/contact"
                    className="px-6 py-3 bg-background text-foreground font-bold rounded-full hover:bg-background/90 transition-colors"
                  >
                    Contact Sales
                  </a>
                </div>
