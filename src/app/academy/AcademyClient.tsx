        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            <h1 className="text-6xl md:text-8xl font-bold text-foreground mb-8 tracking-tighter">
              <HeroWords>ZecurX Professional Certificates</HeroWords>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {courses.map((course, index) => (
              ...
              >
                <CourseCard {...course} delay={index * 0.1} />
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-background/80 text-xl font-light leading-relaxed mb-12 max-w-md">
              Customized security capability building for engineering and
              operations teams.
            </p>
            <a
              href="/contact"
