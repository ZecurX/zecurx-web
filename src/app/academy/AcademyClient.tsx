            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <div>
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-[#0c1a2e] mb-6 leading-[1.05] font-manrope">
                  ...
                  <span className="hero-word text-[#4c69e4]" data-delay="400">Professional</span><br />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-y md:divide-y-0 md:divide-x divide-slate-200/60">
              {stats.map((stat, idx) => (
                <div key={idx} className="flex flex-col items-center justify-center py-4 md:py-8 group">
                  <span className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0c1a2e] mb-2 font-manrope transition-colors duration-300 group-hover:text-[#4c69e4]">
                    {stat.value}
                  </span>
            ...
            >
              <div>
                ...
                <h2 className="text-3xl md:text-5xl font-manrope font-bold text-[#0c1a2e] mb-4">
                  Professional <span className="text-[#4c69e4]">Programs</span>
                </h2>
              ...
              <div className="flex items-center gap-3">
                ...
                <Link
                  href="/cart"
                  className="flex items-center gap-2 px-6 py-3 text-sm font-medium bg-[#4c69e4] text-white rounded-full hover:bg-[#375bde] transition-colors shadow-sm"
                >
        ...
        <section className="py-20 md:py-32 px-6 relative z-10">
          <div className="max-w-[1000px] mx-auto">
            <motion.div 
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="relative p-10 md:p-16 rounded-[2.5rem] border border-[#4c69e4]/20 bg-gradient-to-br from-[#f8fbff] to-blue-50/50 shadow-[0_20px_60px_rgba(74,111,250,0.08)] overflow-hidden text-center"
            >
              <div className="absolute inset-0 z-0">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-3xl md:text-5xl font-manrope font-bold text-[#0c1a2e] mb-6">
                  <span className="text-[#4c69e4]">Enterprise</span> Training
                </h2>
