...
const complianceCaseStudies: CaseStudy[] = [
    {
        ...
        image: "https://images.unsplash.com/photo-1507925921958-8a62f3d1a50d?w=600&h=800&fit=crop",
        icon: "Award",
        metrics: [
    ...
    },
    {
        ...
        metrics: [
            ...
            { value: "$2M", label: "Deal Unlocked", sub: "Enterprise contract signed" },
        ],
    },
    {
        id: 3,
        ...
        metrics: [
            ...
            { value: "30", label: "Days to Comply", sub: "Ahead of regulatory deadline" },
        ],
    },
];
