        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-[#0c1a2e] mb-6 leading-[1.05] font-manrope">
              <span className="hero-word" data-delay="300">Compliance</span>{" "}
              <span className="hero-word text-[#4a69e6]" data-delay="400">Readiness</span>
            </h1>
            ...
            >
              Prepare for security compliance without slowing down your product development. We help you navigate{" "}
              <WordRotate
                words={["ISO 27001", "SOC 2 Type II", "DPDP Act"]}
