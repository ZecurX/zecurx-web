...
const cloudCaseStudies: CaseStudy[] = [
    {
        ...
        icon: "Cloud",
        metrics: [
            { value: "14", label: "Exposed Buckets Fixed", sub: "Containing customer PII" },
    ...
    },
    {
        ...
        icon: "Container",
        metrics: [
            { value: "8", label: "Critical K8s Fixes", sub: "Pod security, RBAC, network" },
    ...
    },
    {
        ...
        metrics: [
            ...
            { value: "100%", label: "Pipeline Coverage", sub: "Automated secret scanning" },
        ],
    },
];
