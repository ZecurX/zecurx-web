        ...
        <section className="py-16 md:py-24 px-4 md:px-6 border-y border-border/40 relative bg-muted/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-[#4c69e4] mt-4 text-lg">
        ...
        <section className="py-10 md:py-16 px-4 md:px-6 relative overflow-hidden">
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            >
              ...
              <p className="text-base md:text-xl text-[#4c69e4] leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
              ...
              >
                ...
                <p className="text-base md:text-xl text-muted-foreground mb-6 md:mb-8 leading-relaxed">
                  ...
                  <span
                    className="font-bold text-[#4c69e4]"
                ...
                <ul className="space-y-4 mb-10">
                  {[
                    ...
                    <li
                      key={idx}
                      className="flex items-center text-base md:text-lg text-[#4c69e4]"
                    >
                      <CheckCircle2 className="w-6 h-6 text-[#4c69e4] mr-4 shrink-0" />
                      {feature}
                    </li>
                  ))}
                </ul>
