        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-[#0c1a2e] mb-6 leading-[1.05] font-manrope">
              <span className="hero-word" data-delay="300">Secure AI</span>{" "}
              <span className="hero-word text-[#4a6ffa]" data-delay="400">Development</span>
            </h1>
            ...
            >
              We build AI-powered applications with security embedded from architecture to deployment. Secure your{" "}
              <WordRotate
                words={["LLM integration", "agentic workflows", "RAG pipelines"]}
