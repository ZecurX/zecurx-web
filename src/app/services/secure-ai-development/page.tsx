...
const aiCaseStudies: CaseStudy[] = [
    {
        ...
        icon: "Brain",
        metrics: [
            { value: "99.7%", label: "Attacks Blocked", sub: "Post-guardrails implementation" },
            { value: "15", label: "Jailbreaks Found", sub: "During red team exercise" },
        ],
    },
    {
        id: 2,
        ...
        metrics: [
            ...
            { value: "3x", label: "Faster Compliance", sub: "For enterprise onboarding" },
        ],
    },
    {
        id: 3,
        ...
        icon: "Bot",
        metrics: [
            { value: "100%", label: "Critical Actions Gated", sub: "Human-in-the-loop" },
            { value: "5", label: "Escape Paths Closed", sub: "Agent sandbox hardened" },
        ],
    },
];
