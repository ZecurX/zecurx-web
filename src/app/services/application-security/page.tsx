            ...
            <div>
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl mb-10">
                <HeroWords delay={heroEnd(5)}>
                  ...
                  applications, APIs, and codebases before attackers exploit
                  them.
                </HeroWords>
              </p>
              ...
              <FadeUpScroll>
                <div className="lg:sticky lg:top-32">
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                    Actionable intelligence, not just a list of bugs. We provide
                    the context you need to fix issues fast.
                  </p>
