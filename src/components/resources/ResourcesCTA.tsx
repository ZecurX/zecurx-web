    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 w-full max-w-4xl px-4 flex flex-col items-center gap-8">
                ...
                >
                    Learn. Defend. <br className="hidden md:block" />
                ...
                >
                    Empower your security journey with industry-leading resources, expert insights, and comprehensive training programs.
                </motion.p>
                ...
                >
                    ...
                    <a href="https://lms.zecurx.com" target="_blank" rel="noopener noreferrer">
                        <Button
                            variant="outline"
