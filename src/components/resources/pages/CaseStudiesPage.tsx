                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center flex flex-col items-center">
                    ...
                    >
                        <Link href="/resources" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors mb-8 text-xs font-mono tracking-widest uppercase bg-white/[0.05] px-3 py-1.5 rounded-full border border-white/[0.05] hover:bg-white/[0.1]">
                            ...
                            <span>Resources / Case Studies</span>
                        </Link>
                        ...
                        <div className="lg:col-span-3">
                            {loading ? (
                                ...
                                <div className="flex flex-col items-center justify-center h-64 text-center">
                                    ...
                                    <h3 className="text-lg font-medium text-foreground">No case studies available</h3>
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="flex items-start justify-between mb-4">
                                                        ...
                                                        {study.pages > 0 && (
                                                            <span className="text-xs text-muted-foreground">{study.pages} pages</span>
                                                        )}
                                                    </div>

                                                    <span className="text-xs text-muted-foreground mb-2 block">{study.category}</span>
