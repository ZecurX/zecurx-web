                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center flex flex-col items-center">
                    ...
                    >
                        ...
                        <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight text-foreground mb-6 relative z-20">
                            Technical<br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Whitepapers</span>
                        </h1>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                {whitepapers.map((paper, i) => (
                                    ...
                                    >
                                        ...
                                        <h3 className="text-xl font-manrope font-semibold text-foreground mb-3 group-hover:text-blue-400 transition-colors">
                                            {paper.title}
                                        </h3>
