                ...
                <div className="text-center max-w-3xl mx-auto mb-20">
                    ...
                    <BlurFade delay={0.3}>
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-manrope text-[#0c1a2e] mb-6 tracking-tight leading-[1.1]">
                            Security <span className="text-[#4a6ffa]">Guides</span>
                        </h1>
                    </BlurFade>
                    ...
                    {guideCategories.map((cat, i) => (
                        <BlurFade key={i} delay={0.3 + (i * 0.1)}>
                            <div className="group bg-white rounded-3xl p-6 border border-slate-200/60 shadow-[0_18px_44px_rgba(30,58,95,0.05)] hover:shadow-[0_20px_55px_rgba(30,58,95,0.12)] hover:-translate-y-1 transition-all duration-300 cursor-pointer h-full relative overflow-hidden">
                                <div className="absolute top-0 right-0 w-24 h-24 bg-[#4a6ffa]/5 blur-[30px] rounded-full group-hover:bg-[#4a6ffa]/10 transition-colors" />
                                <div className="relative z-10 flex flex-col items-center text-center">
                                    <div className="w-14 h-14 rounded-2xl bg-[#f8fbff] border border-blue-100 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 text-[#4a6ffa]">
                                        <cat.icon className="w-6 h-6" />
                                    </div>
                                    <h4 className="font-semibold font-manrope text-[#0c1a2e] text-lg mb-1 group-hover:text-[#4a6ffa] transition-colors">{cat.label}</h4>
                    ...
                    {guides.map((guide, i) => (
                        <BlurFade key={i} delay={0.5 + (i * 0.1)}>
                            <div className="group glass-card rounded-3xl p-8 border border-slate-200/60 shadow-[0_18px_44px_rgba(30,58,95,0.05)] bg-white/50 hover:shadow-[0_20px_55px_rgba(30,58,95,0.12)] hover:-translate-y-1 transition-all duration-300 cursor-pointer relative overflow-hidden">
                                <div className="absolute left-0 top-0 w-1 h-full bg-[#4a6ffa]/20 group-hover:bg-[#4a6ffa] transition-colors" />
                                <div className="flex flex-col lg:flex-row lg:items-center gap-6">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-4">
                                            <span className="px-3 py-1 text-[11px] font-space-grotesk font-semibold tracking-widest text-[#4a6ffa] uppercase bg-blue-50 rounded-full">
                                                {guide.category}
                                            </span>
                                        ...
                                        <h3 className="text-2xl font-manrope font-bold text-[#0c1a2e] mb-3 group-hover:text-[#4a6ffa] transition-colors">
                                            {guide.title}
                                        </h3>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {guide.topics.map((topic, j) => (
                                                <span key={j} className="flex items-center gap-1.5 px-3 py-1.5 text-[13px] font-inter text-slate-500 bg-white border border-slate-200 rounded-full shadow-sm">
                                                    <CheckCircle className="w-3.5 h-3.5 text-[#4a6ffa]" />
                                                    {topic}
                                                </span>
                                            ))}
                                        </div>
                                    ...
                                    <div className="flex-shrink-0 mt-4 lg:mt-0">
                                        <button className="relative inline-flex items-center justify-center gap-2 bg-white text-[#0c1a2e] rounded-full px-6 py-3 text-sm font-semibold font-inter cursor-pointer border border-slate-200 hover:border-[#4a6ffa] hover:text-[#4a6ffa] hover:bg-[#f8fbff] transition-all duration-200 shadow-sm">
