        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <BlurFade delay={0.1} inView={true} direction="up">
              ...
              >
                Security that{" "}
                <span className="text-[#4a6ffa]" style={{ fontFamily: 'var(--font-caveat)', fontSize: '1.2em' }}>moves</span>
                <br />
                as fast as you do.
              </h1>
            </BlurFade>
