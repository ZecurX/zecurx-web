            ...
            <div className="relative z-10 min-h-screen flex flex-col justify-between items-center px-8 py-12 md:px-16 md:py-20">
                ...
                <div className="text-center max-w-5xl mx-auto">
                    <h1 className="text-3xl md:text-5xl lg:text-7xl font-newsreader font-medium leading-tight tracking-tight text-foreground">
                        <div className="mb-4 md:mb-6">
                            ...
                            <span className="hero-word italic text-muted-foreground" data-delay="2350">
                                confidence.
                            </span>
                        </div>
                ...
                <div className="text-center">
                    ...
                    <h2 className="text-xs md:text-sm font-manrope font-light uppercase tracking-[0.2em] text-muted-foreground">
                        <span className="hero-word" data-delay="4400">
                            Application Security
                        </span>{" "}
                        <span className="hero-word" data-delay="4550">
                            ·
                        </span>{" "}
                        <span className="hero-word" data-delay="4700">
                            Cloud & DevSecOps
                        </span>{" "}
                        <span className="hero-word" data-delay="4850">
                            ·
                        </span>{" "}
                        <span className="hero-word" data-delay="5000">
                            AI Security
                        </span>{" "}
                        <span className="hero-word" data-delay="5150">
                            ·
                        </span>{" "}
                        <span className="hero-word" data-delay="5300">
                            Compliance
                        </span>
                    </h2>
                    <div
