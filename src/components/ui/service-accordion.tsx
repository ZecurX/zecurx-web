        ...
        return (
          <div
            ...
            className={cn(
              ...
              isOpen 
                ? "bg-white border-[#4c69e4]/20 shadow-[0_8px_30px_rgb(0,0,0,0.04)]" 
          ...
          >
            ...
            <div 
              className={cn(
                "absolute left-0 top-0 bottom-0 w-1 bg-[#4c69e4] transition-transform duration-300 ease-out origin-top",
            ...
            >
              ...
              <div className={cn(
                ...
                isOpen ? "bg-[#4c69e4]/5" : "bg-transparent group-hover:bg-slate-50"
              )}>
                <ChevronDown
                  className={cn(
                    "w-5 h-5 transition-transform duration-300 ease-out",
                    isOpen ? "rotate-180 text-[#4c69e4]" : "text-slate-400 group-hover:text-slate-600"
                  )}
                />
              </div>
            </button>
