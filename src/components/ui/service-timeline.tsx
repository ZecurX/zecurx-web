            ...
            >
              ...
              <div 
                className={cn(
                  ...
                  "transition-all duration-300 group-hover:border-[#4a6ffa]/30 group-hover:shadow-[0_0_20px_rgba(74,111,250,0.15)] group-hover:scale-110"
                )}
              >
                <div className="w-10 h-10 rounded-xl bg-slate-50 flex items-center justify-center transition-colors duration-300 group-hover:bg-[#4a6ffa]/10">
                  <Icon className="w-5 h-5 text-slate-500 transition-colors duration-300 group-hover:text-[#4a6ffa]" />
                </div>
              </div>
              ...
              >
                ...
                <div className="w-full relative bg-white/60 hover:bg-white backdrop-blur-sm border border-slate-200/60 hover:border-slate-300/80 p-6 sm:p-8 rounded-2xl transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                  ...
                  <div className={cn(
                    "absolute top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-[#4a6ffa] opacity-0 transition-opacity duration-300 group-hover:opacity-100 hidden sm:block",
                    isEven ? "-right-3" : "-left-3"
                  )} />
                  
                  <h3 className="text-xl sm:text-2xl font-bold font-manrope text-[#0c1a2e] mb-3 group-hover:text-[#4a6ffa] transition-colors duration-300">
                    {item.title}
                  </h3>
