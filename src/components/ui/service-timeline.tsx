            ...
            >
              ...
              >
                ...
                <div className="w-full relative bg-white/60 hover:bg-white backdrop-blur-sm border border-slate-200/60 hover:border-slate-300/80 p-6 sm:p-8 rounded-2xl transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                  ...
                  <div className={cn(
                    "absolute top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-[#4c69e4] opacity-0 transition-opacity duration-300 group-hover:opacity-100 hidden sm:block",
                    isEven ? "-right-3" : "-left-3"
                  )} />
                  
                  <h3 className="text-xl sm:text-2xl font-bold font-manrope text-[#0c1a2e] mb-3 group-hover:text-[#4c69e4] transition-colors duration-300">
                    {item.title}
                  </h3>
