...
export default function ReadyToSecureSection() {
    ...
    return (
        <section
            ref={containerRef}
            className="relative w-full h-[500px] flex flex-col items-center justify-center text-center overflow-hidden bg-black"
        >
            {/* Parallax Background */}
            <motion.div
            ...
            <div className="relative z-10 w-full max-w-4xl px-4 flex flex-col items-center gap-8">
                ...
                >
                    ...
                    <Button variant="secondary" className="h-12 px-8 rounded-full flex items-center gap-2 group">
                        Request Assessment
