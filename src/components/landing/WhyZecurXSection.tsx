...
export default function WhyZecurXSection() {
    return (
        <section className="relative w-full py-24 bg-[#050505] text-white overflow-hidden flex flex-col items-center">

            {/* Background Ambience */}
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                {/* Top Right Glow */}
                <div className="absolute top-[20%] right-[-10%] w-[600px] h-[600px] bg-blue-900/10 rounded-full blur-[120px]"></div>
                {/* Bottom Left Glow (for End-to-End section) */}
                <div className="absolute bottom-[0%] left-[-20%] w-[800px] h-[800px] bg-indigo-900/10 rounded-full blur-[150px] opacity-60"></div>
                {/* Center subtle glow */}
                <div className="absolute top-[60%] right-[10%] w-[500px] h-[500px] bg-blue-600/5 rounded-full blur-[100px]"></div>
            </div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 space-y-32">
                ...
                >
                    <motion.div variants={itemVariants}>
                        <span className="text-blue-500 font-manrope font-semibold tracking-widest text-sm uppercase mb-4 block">
                            Who We Are
                        </span>
                        <h2 className="text-5xl md:text-7xl font-manrope font-light text-white leading-[1.1] mb-8">
                            Trust. <br />
                    ...
                    <motion.div variants={itemVariants} className="space-y-8">
                        <p className="text-xl text-gray-400 font-manrope font-light leading-relaxed">
                            ZecurX operates at the intersection of <span className="text-white font-medium">offensive security, defensive strategy, and secure innovation</span>. Our work is threat-driven, intelligence-led, and focused on reducing real organizational risk.
                        </p>
                        <p className="text-xl text-gray-400 font-manrope font-light leading-relaxed">
                ...
                >
                    {[
                        ...
                        <motion.div variants={itemVariants} key={i} className="p-8 rounded-3xl bg-[#0A0A0A]/80 backdrop-blur-sm border border-white/5 hover:border-white/10 transition-colors group relative overflow-hidden">
                ...
                <motion.div
                    ...
                    whileInView="visible"
                    viewport={{ once: true, margin: "-100px" }}
                    className="border-t border-white/5 pt-24 relative"
                >
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start gap-12 relative z-10">
                        <motion.div variants={itemVariants} className="md:w-1/3">
                            <span className="text-indigo-500 font-manrope font-semibold tracking-widest text-sm uppercase mb-4 block">
                                What We Do
                            </span>
                            <h3 className="text-4xl font-manrope font-medium text-white mb-4">
                        ...
                        <motion.div variants={containerVariants} className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {[
                                ...
                                <motion.div variants={itemVariants} key={i} className="group relative p-6 rounded-2xl bg-zinc-900/30 backdrop-blur-md border border-white/5 hover:border-white/10 transition-all duration-300 overflow-hidden">
                                    {/* Hover Gradient */}
                                    ...
                                    <div className="relative z-10 flex flex-col h-full justify-between">
                                        ...
                                        <div>
                                            <h4 className="text-lg font-manrope font-semibold text-white mb-1 group-hover:text-indigo-100 transition-colors">
                                                {item.title}
                                            </h4>
                                            <p className="text-sm text-gray-500 font-manrope group-hover:text-gray-400 transition-colors">
                                                {item.sub}
                                            </p>
                                        </div>
                                    </div>
