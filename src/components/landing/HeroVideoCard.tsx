...
export default function HeroVideoCard() {
    return (
        <div className="relative mt-20 w-full max-w-5xl mx-auto aspect-video bg-muted/30 border border-border rounded-2xl overflow-hidden shadow-2xl backdrop-blur-sm z-10 flex items-center justify-center group">

            {/* Placeholder / Fallback Content */}
            <div className="text-center">
                <div className="w-16 h-16 bg-muted rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                    <div className="w-0 h-0 border-l-[12px] border-l-foreground border-y-[8px] border-y-transparent ml-1"></div>
                </div>
                <p className="text-muted-foreground font-manrope text-sm">Watch Platform Demo</p>
            </div>
